...
# default evoman.environment fitness is assumed for experiment

env.state_to_log()  # checks evoman.environment state
...
np.random.seed(420)  # what is this?

# //// EVERYTHING BELOW THIS IS THE SAME AS THE SPECIALIST DEMO ////
    ...
    for p in range(0, pop.shape[0], 2):
        ...
        for f in range(0, n_offspring):
            ...
            offspring[f] = np.array(
                list(map(lambda y: limits(y), offspring[f])))
