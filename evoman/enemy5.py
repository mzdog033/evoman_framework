        ...
        if game.start == 1:
            ...
            for cell in game.tilemap.layers['triggers'].collide(game.player.rect, 'blockers'):
                ...
                if 't' in blockers:
                    ...
                    game.player.rect.x += self.direction_floor * \
                        100 * dt  # moves player over the moving floor
            ...
            if (atack2 == 1 and not self.gun_cooldown):
                ...
                for i in range(0, aux):
                    self.twists.append(Bullet_e5((self.rect.x + (self.direction*(i*30)), self.rect.top + (
                        self.direction*(i*20))), self.direction, game.player.rect, len(self.twists), game.sprite_e))
            ...
            if game.player.atacked == 1:
                ...
                self.twists.append(Bullet_e5((self.rect.x, self.rect.top),
