...
class Enemy(pygame.sprite.Sprite):
    ...
    def update(self, dt, game):
        ...
        if game.start == 1:
            ...
            aux_dist = (abs(game.player.rect.right -
                        self.rect.right)/490.0)+0.3
            ...
            if atack1 == 1:
                ...
                self.twists.append(Bullet_e7(
                    (self.rect.x, self.rect.y), self.direction, len(self.twists), game.sprite_e))
            ...
            if self.bullets == 0:
                ...
                for i in range(0, rand):
                    if atack3 == 1:
                        ...
                        self.bullets += 1
                        self.twists.append(Bullet_e72(
                            (self.rect.x+self.direction*i*30, self.rect.y-i*30), self.direction, len(self.twists), game.sprite_e))
            ...
            if self.resting == 0:
                if self.direction == -1:
                    self.updateSprite(SpriteConstants.JUMPING,
...
class Bullet_e72(pygame.sprite.Sprite):
    ...
    def update(self, dt, game):
        ...
        self.rect.x += self.direction * 200 * dt * \
            0.5      # moves the bullets on the axis x
